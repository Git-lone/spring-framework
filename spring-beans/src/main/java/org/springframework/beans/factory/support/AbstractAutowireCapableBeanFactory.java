...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
	...
	protected Object doCreateBean(String beanName, RootBeanDefinition mbd, @Nullable Object @Nullable [] args)
		...
		// ⭐⭐在实例化后、属性赋值前(即Bean还未完成初始化)被存入三级缓存
	...
	protected Object initializeBean(String beanName, Object bean, @Nullable RootBeanDefinition mbd) {
		...
		// 通过让bean实现Aware接口，可以在bean中获得相应的Spring资源
	...
	protected void invokeInitMethods(String beanName, Object bean, @Nullable RootBeanDefinition mbd)
			throws Throwable {
		// 3.3.1.若实现 InitializingBean 接口，调用 afterPropertiesSet() 方法
		...
		if (mbd != null && bean.getClass() != NullBean.class) {
			...
			// 3.3.2.若配置自定义的 init-method方法，则执行自定义的方法
